...
import { Template, WhatsAppSession, BroadcastContact, BroadcastStats } from '../types.ts';
...
const Broadcast: React.FC<BroadcastProps> = ({ templates, contacts, wa, stats, onStart, onImportCSV, sending }) => {
    ...
    const formatPreview = (content: string) => {
        if (!content) return '';
        return content.replace(/\[name\]|\{name\}/g, 'John Doe');
    };
    ...
    return (
        <div className="flex-1">
            {/* Campaign Header */}
            <header className="sticky top-0 z-30 bg-[#f8fafc]/80 backdrop-blur-md -mx-6 md:-mx-8 lg:-mx-12 -mt-6 md:-mt-8 lg:-mt-12 mb-8 md:mb-10 px-6 md:px-8 lg:px-12 py-6 md:py-8 lg:py-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mb-10">
                <div className="card-premium p-6">
                    <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-1">Total Recipients</p>
                    <div className="flex items-end justify-between">
                        <h3 className="text-3xl font-extrabold text-slate-900">{contacts.length.toLocaleString()}</h3>
                        <div className="text-[10px] font-bold text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded-full mb-1">Live</div>
                    </div>
                </div>
                <div className="card-premium p-6 border-l-4 border-l-red-500">
                    <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-1">Daily Limit</p>
                    <div className="flex items-end justify-between">
                        <h3 className="text-3xl font-extrabold text-slate-900">5,000</h3>
                        <span className="text-[10px] font-bold text-slate-400 mb-1">Used {limitUsage}%</span>
                    </div>
                </div>
                <div className="card-premium p-6">
                    <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-1">Safety Buffer</p>
                    <div className="flex items-end justify-between">
                        <h3 className="text-3xl font-extrabold text-slate-900">3-7s</h3>
                        <span className="text-[10px] font-bold text-slate-400 mb-1">Randomized</span>
                    </div>
                </div>
                <div className="card-premium p-6">
                    ...
                    <div className="flex items-end justify-between">
                        ...
                        <span className="text-[10px] font-bold text-slate-400 mb-1">Campaign Avg</span>
                    </div>
                </div>
            </div>
                                    ...
                                    <table className="w-full text-left">
                                        <thead className="sticky top-0 bg-white z-10 border-b border-slate-50">
                                            <tr className="text-[10px] uppercase tracking-widest text-slate-400">
                                                <th className="py-5 font-bold">Identity</th>
                                                <th className="py-5 font-bold">Destination</th>
