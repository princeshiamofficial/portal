  ...
  return (
    <div className="flex h-screen w-full bg-[#f8fafc] overflow-hidden font-sans relative selection:bg-red-500/20">
      ...
      <div className={`flex-1 flex flex-col min-w-0 overflow-hidden relative transition-all duration-300`}>
        ...
        <main className={`flex-1 overflow-y-auto relative px-4 ${[View.DASHBOARD, View.DEVICES, View.SPECIAL_CAMPAIGN, View.SETTINGS].includes(activeView) ? 'pt-[100px]' : 'pt-28'} pb-6 md:p-8 lg:p-12 lg:pt-12 custom-scrollbar lg:pb-12`}>
